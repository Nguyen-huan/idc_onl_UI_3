			...
			<div class="feature-section three-col">
				<div class="col">
					<div class="widgets-holder-wrap">
						...
						<p><?php esc_html_e("Thank you for trying Audio Player , feel free to contact us for any support regarding our theme.", "product-affiliate"); ?></p>
				...
				<div class="col">
					<div class="widgets-holder-wrap">
						...
						<p><?php esc_html_e("If You love Audio Player theme then we would appreciate your review about our theme.", "product-affiliate"); ?></p>
