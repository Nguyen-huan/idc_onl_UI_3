...
add_action( 'customize_register', function( $manager ) {
    ...
    $manager->add_section(
        new Product_Affiliate_Button( $manager, 'product_affiliate_pro', [
            'title'       => __( 'Product Affiliate Pro', 'product-affiliate' ),
            'priority'    => 0,
            'button_text' => __( 'GET PREMIUM', 'product-affiliate' ),
            'button_url'  => esc_url( 'https://www.themagnifico.net/themes/product-affiliate-wordpress-theme/', 'product-affiliate')
        ] )
    );
